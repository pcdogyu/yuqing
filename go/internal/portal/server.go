...
func (s *Server) handleProjects(w http.ResponseWriter, r *http.Request, user any) {
	...
	_ = s.render(w, "projects", pageData{Title: "项目中心", User: user, Groups: groups, Projects: projects, FilterKeyword: keyword, FilterStatus: status, Message: r.URL.Query().Get("msg")})
}
...
func (s *Server) handleRules(w http.ResponseWriter, r *http.Request, user any) {
	...
	_ = s.render(w, "rules", pageData{Title: "监测规则", User: user, Rules: rules, Projects: projects, FilterKeyword: keyword, FilterStatus: status, Message: r.URL.Query().Get("msg")})
}
