...
func TestAStockRecommendationSnapshotAPIUpsertsAndGets(t *testing.T) {
	...
	payload := `{"strategy_date":"2026-06-22","period":"afternoon","ignore_recent":false,"recommendations_json":"[{\"Code\":\"600000\"}]","backtests_json":"[]","backtest_status":"已回测 1/1","generated_count":1,"limit_up_filter_enabled":true,"limit_up_filtered":2,"today_market_filter_enabled":true,"no_today_market_count":4,"fund_flow_filter_enabled":true,"fund_flow_filtered":3,"fund_flow_missing_count":1,"market_candidate_count":9}`
