...
func TestLoadUsesDefaults(t *testing.T) {
	...
	t.Setenv("YUQING_COINLORE_URL", "")
	t.Setenv("YUQING_COINGECKO_URL", "")
	...
	unsetEnv(t, "YUQING_THEBLOCK_LATEST_URL")
	...
	unsetEnv(t, "YUQING_SINA_FINANCE_REPORT_URL")
	unsetEnv(t, "YUQING_EASTMONEY_REPORT_URL")
	...
	t.Setenv("YUQING_FORESIGHT_NEWSFLASH_INTERVAL_SEC", "")
	t.Setenv("YUQING_COINDESK_ZH_LATEST_INTERVAL_SEC", "")
	t.Setenv("YUQING_PANEWS_NEWSFLASH_INTERVAL_SEC", "")
	t.Setenv("YUQING_THEBLOCK_LATEST_INTERVAL_SEC", "")
	...
	t.Setenv("YUQING_GATEWAY_URL", "")
	t.Setenv("JIN10_PORTAL_WEB_URL", "")
	t.Setenv("YUQING_WECHAT_URL", "")
