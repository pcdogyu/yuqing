...
func crawlTemplateSourceOptions(selected string) string {
	...
	options := []struct {
		...
		{provider.SourceTypeEastMoneyKuaixun, "东方财富快讯"},
		{provider.SourceTypeEastMoneyFull, "东方财富全站"},
