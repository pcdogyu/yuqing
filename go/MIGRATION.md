...
- OCR 与外部平台集成已补齐正式报告预览接口、能力清单和文档，平台工作台优先消费正式 `nlp-service` 能力，因此状态更新为“兼容完成”。
...
| `兼容完成` | 18 | 微信、邮件、弹窗、验证码、移动端、大屏、音量、热点、试用申请、用户资料、全文搜索、即时搜索、LSearch、PublicOption、Platform、高级全文检索剩余能力、复杂分析、OCR/外部平台 |
| `部分完成` | 0 | - |
| `未完成` | 1 | legacy 收口 |
