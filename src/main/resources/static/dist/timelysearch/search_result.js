...
function thirdBox(type_two_id){
	...
	ajax('GET',ctx + 'timelysearch/listFullTypeByThird', data, setThirdBox);
}
...
function lawyerList(page){
	...
	ajaxAsync('GET',ctx + 'timelysearch/lawyerList', data, installLawyer);
}
...
function executionPersonList(page){
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/executionPersonList', data, installExecutionPerson);
}
...
function professorList(page){
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/professorList', data, installProfessor);
}
...
function doctorList(page){
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/doctorList', data, installDoctor);
}
...
function informationList(page){
	...
	//必须用这个
	// ajaxAsync('GET',ctx + 'timelysearch/informationList', data1, installArticle3);

	ajaxAsync('POST',ctx + 'timelysearch/informationListpost',JSON.stringify(data), installArticle3);
}
...
function hotList(page){
	...
	var data = getArticleData(page);
	showorhidde();
	ajaxAsync('GET',ctx + 'timelysearch/hotList', data, installHot);
}
...
function complaintList(page){
	showorhidde();
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/complaintList', data, installComplaint);
}
...
function announcementList(page){
	showorhidde();
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/announcementList', data, installAnnouncement);
}
/**
 * 公告分类
 * @param page
...
function announcementType(){
	...
	ajaxAsync('GET',ctx + 'timelysearch/announcementrtype', data, setThirdBox);
}
...
function reportList(page){
	showorhidde();
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/reportList', data, installReport);
}
/**
 * 研报分类
 * @param page
...
function reportType(){
	showorhidde();
	var data = getArticleData(1);
	ajaxAsync('GET',ctx + 'timelysearch/reportIndustry', data, setThirdBox);
}
...
function biddingList(page){
	showorhidde();
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/biddingList', data, installBidding);
}
...
function inviteList(page){
	showorhidde();
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/inviteList', data, installInvite);
}
...
function companyList(page){
	showorhidde();
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/companyList', data, installCompany);
}
...
function companyIndustry(){
	var data = getArticleData(1);
	ajaxAsync('GET',ctx + 'timelysearch/companyIndustry', data, setThirdBox);
}
...
function judgmentList(page){
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/judgmentList', data, installJudgment);
}
/**
 * 法律文书案件类型
 * @returns
...
function judgmentCaseType(){
	var data = getArticleData(1);
	ajaxAsync('GET',ctx + 'timelysearch/judgmentCaseType', data, setThirdBox);
}
/**
 * 知识产权
 * @param page
...
function knowLedgeList(page){
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/knowLedgeList', data, installKnowLedge);
}
/**
 * 知识产权分类
 * @returns
...
function knowLedgeCaseType(){
	var data = getArticleData(1);
	ajaxAsync('GET',ctx + 'timelysearch/knowLedgeCaseType', data, setThirdBox);
}
...
function investmentList(page){
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/investmentList', data, installInvestment);
}
/**
 * 投资融资 分类
 * @returns
...
function investmentType(){
	var data = getArticleData(1);
	ajaxAsync('GET',ctx + 'timelysearch/investmentType', data, setThirdBox);
}
...
function baiduKnowsList(page){
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/baiduKnowsList', data, installBaiduKnows);
}
...
function thesisnList(page){
	var data = getArticleData(page);
	ajaxAsync('GET',ctx + 'timelysearch/thesisnList', data, installThesisn);
}
    ...
    $("#page").bootstrapPaginator({
        ...
        onPageClicked: function (event, originalEvent, type, page) {
            ...
            if(full_type == 8){
            	...
            	articleParam.url = ctx + "timelysearch/companyList";
            }else if(full_type == 40){
            	articleParam.url = ctx + "timelysearch/investmentList";
            }else if(full_type == 41){
            	articleParam.url = ctx + "timelysearch/baiduKnowsList";
            }else if(full_type == 42){
            	articleParam.url = ctx + "timelysearch/judgmentList";
            }else if(full_type == 43){
            	articleParam.url = ctx + "timelysearch/knowLedgeList";
            }else if(full_type == 45){
            	articleParam.url = ctx + "timelysearch/thesisnList";
            }else if(full_type == 100){
            	articleParam.url = ctx + "timelysearch/lawyerList";
            }else if(full_type == 101){
            	articleParam.url = ctx + "timelysearch/executionPersonList";
            }else if(full_type == 102){
            	articleParam.url = ctx + "timelysearch/professorList";
            }else if(full_type == 103){
            	articleParam.url = ctx + "timelysearch/doctorList";
            }
				setUrl(seturl);
            ...
            if(full_type == 1) {
				...
				articleParam2.url = ctxPath + "timelysearch/informationListpost";
