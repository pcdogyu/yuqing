...
const portalChannelPlaceholder = `来源，如 flash,headline,jin10_full,eastmoney_kuaixun,crypto_x,crypto_telegram,foresight_newsflash,coindesk_zh_latest,panews_newsflash`
