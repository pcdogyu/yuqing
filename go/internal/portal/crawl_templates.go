...
func (s *Server) handleCrawlTemplatesPage(w http.ResponseWriter, r *http.Request, user any) {
	if r.Method == http.MethodPost {
		...
		http.Redirect(w, r, "/crawl-templates?"+target.Encode(), http.StatusSeeOther)
		return
	}
	...
	body.WriteString(`<section><div class="toolbar"><a href="/">总览</a><a href="/projects">项目</a><a href="/monitor-rules">规则</a><a href="/reports">报告</a><a href="/crawl-templates">模板管理</a><a href="/system">系统</a><a href="/crypto">Crypto</a></div><h1>抓取模板管理</h1><p class="subtle">欢迎，用户 `)
