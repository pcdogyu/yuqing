...
data class AStockBacktestRow(
    ...
    @SerialName("CurrentMarketPct") val currentMarketPct: String = "",
    @SerialName("CurrentMarketPctClass") val currentMarketPctClass: String = "",
...
data class AStockBacktestCell(
    ...
    @SerialName("MarketPct") val marketPct: String = "",
    @SerialName("MarketPctClass") val marketPctClass: String = "",
)
...
data class StockResearch(
    ...
    val analyst: String = "",
    val rating: String = "",
    @SerialName("target_price") val targetPrice: String = "",
    ...
    @SerialName("source_fetch_status") val sourceFetchStatus: String = "",
    @SerialName("source_fetch_error") val sourceFetchError: String = "",
    @SerialName("source_fetched_at") val sourceFetchedAt: String = "",
    @SerialName("pdf_url") val pdfUrl: String = "",
    @SerialName("pdf_file_path") val pdfFilePath: String = "",
    @SerialName("pdf_status") val pdfStatus: String = "",
    @SerialName("pdf_text") val pdfText: String = "",
    @SerialName("pdf_error") val pdfError: String = "",
    @SerialName("pdf_fetched_at") val pdfFetchedAt: String = "",
    @SerialName("pdf_parsed_at") val pdfParsedAt: String = "",
    @SerialName("nlp_score") val nlpScore: Double = 0.0,
    @SerialName("nlp_rating") val nlpRating: String = "",
    @SerialName("nlp_reason") val nlpReason: String = "",
    @SerialName("nlp_scored_at") val nlpScoredAt: String = "",
)
