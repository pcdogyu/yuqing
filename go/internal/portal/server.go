...
const portalFooterHTML = `<footer class="site-footer"><div>Code By Yuhao@jiansutech.com - {{.FooterBuildTime}} - {{.FooterCommit}} - {{.FooterBranch}}</div></footer>` + portalRulesFormEnhancementScript + portalSystemServiceLogsScript
