...
func TestHotspotsPageRendersSwitchingData(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"13:11",
		"创新药",
		`.fundflow-section{width:100vw`,
		`.fundflow-chart{width:100%;height:721px`,
		`viewBox="0 0 1104 721"`,
