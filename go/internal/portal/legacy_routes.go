...
var portalLegacyRoutes = []legacyRouteSpec{
	...
	{LegacyPath: "/fullsearch/search", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/history", CurrentBehavior: "legacy search history JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/getSearchResult", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/full", CurrentBehavior: "legacy full search result JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/informationList*", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/full", CurrentBehavior: "legacy article list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/hotList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/full", CurrentBehavior: "legacy hot article list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/complaintList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/complaint", CurrentBehavior: "legacy complaint list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/announcementList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/announcement", CurrentBehavior: "legacy announcement list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/reportList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/report", CurrentBehavior: "legacy report list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/lawyerList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/lawyer", CurrentBehavior: "legacy special list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/executionPersonList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/executionPerson", CurrentBehavior: "legacy special list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/professorList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/professor", CurrentBehavior: "legacy special list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/doctorList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/doctor", CurrentBehavior: "legacy special list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/biddingList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/bidding", CurrentBehavior: "legacy special list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/inviteList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/invite", CurrentBehavior: "legacy special list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/companyList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/company", CurrentBehavior: "legacy special list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/judgmentList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/judgment", CurrentBehavior: "legacy special list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/knowLedgeList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/knowledge", CurrentBehavior: "legacy special list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/investmentList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/investment", CurrentBehavior: "legacy special list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/baiduKnowsList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/knowledge", CurrentBehavior: "legacy special list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/thesisnList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/thesisn", CurrentBehavior: "legacy special list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/lawyerDetailData", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/lawyer/details/{id}", CurrentBehavior: "legacy special detail JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/executionPersonDetailData", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/executionPerson/details/{id}", CurrentBehavior: "legacy special detail JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/professorDetailData", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/professor/details/{id}", CurrentBehavior: "legacy special detail JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/doctorDetailData", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/doctor/details/{id}", CurrentBehavior: "legacy special detail JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/companyDetails", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/company/details/{id}", CurrentBehavior: "legacy company detail JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/getresearch-report-detail", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/report/details/{id}", CurrentBehavior: "legacy report detail JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/listFullTypeByFirst", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/metadata/types", CurrentBehavior: "legacy type metadata JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/listFullTypeBySecond", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/metadata/types", CurrentBehavior: "legacy type metadata JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/listFullTypeByThird", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/metadata/types", CurrentBehavior: "legacy type metadata JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/listFullTypeOneByIdList", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/metadata/types", CurrentBehavior: "legacy type metadata JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/listFullPolymerization", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/metadata/polymerizations", CurrentBehavior: "legacy polymerization metadata JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/getBreadCrumbs", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/metadata/breadcrumbs", CurrentBehavior: "legacy breadcrumb metadata JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/announcementrtype", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/announcement/options", CurrentBehavior: "legacy special option JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/reportIndustry", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/report/options", CurrentBehavior: "legacy special option JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/companyIndustry", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/company/options", CurrentBehavior: "legacy special option JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/judgmentCaseType", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/judgment/options", CurrentBehavior: "legacy special option JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/knowLedgeCaseType", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/knowledge/options", CurrentBehavior: "legacy special option JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/fullsearch/investmentType", OwnerModule: "FullSearchController", FormalTarget: "/api/v1/search/special/investment/options", CurrentBehavior: "legacy special option JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/timelysearch/*", OwnerModule: "TimelySearchController", FormalTarget: "/articles?mode=timely", CurrentBehavior: "legacy timely search pages, data and detail compatibility flow removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/industry", OwnerModule: "LSearchController", FormalTarget: "/api/v1/search/metadata/types", CurrentBehavior: "legacy industry bucket JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/getevent", OwnerModule: "LSearchController", FormalTarget: "/api/v1/search/metadata/breadcrumbs", CurrentBehavior: "legacy event bucket JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/getProvinceList", OwnerModule: "LSearchController", FormalTarget: "/api/v1/search/full/facets", CurrentBehavior: "legacy province list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/getArticleCityList", OwnerModule: "LSearchController", FormalTarget: "/api/v1/search/full/facets", CurrentBehavior: "legacy city list JSON removed after client migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	...
	{LegacyPath: "/publicoption/loadInformation", OwnerModule: "PublicOptionContoller", FormalTarget: "/api/v1/search/full", CurrentBehavior: "legacy article list JSON removed after workbench migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateClientMigrated},
	{LegacyPath: "/platform/nlp/*", OwnerModule: "PlatformController", FormalTarget: "/api/v1/nlp/*", CurrentBehavior: "legacy platform NLP compatibility endpoints removed after formal NLP API migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateExternalContract},
	{LegacyPath: "/platform/xie/*", OwnerModule: "PlatformController", FormalTarget: "/api/v1/nlp/*", CurrentBehavior: "legacy writing tool compatibility and SSE endpoints removed after formal NLP API migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateExternalContract},
	{LegacyPath: "/mobile/*", OwnerModule: "MobileController", FormalTarget: "/articles and portal SSR pages", CurrentBehavior: "legacy mobile compatibility pages removed after portal migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateExternalContract},
	{LegacyPath: "/displayboard*", OwnerModule: "DisplayBoardController", FormalTarget: "/ and /system?section=operations", CurrentBehavior: "legacy dashboard compatibility pages removed after operations view migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateExternalContract},
	{LegacyPath: "/volume*", OwnerModule: "VolumeController", FormalTarget: "/api/v1/analysis/* and /system?section=operations", CurrentBehavior: "legacy volume compatibility pages removed after analysis view migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateExternalContract},
	{LegacyPath: "/hot/*", OwnerModule: "HotNewsController", FormalTarget: "/api/v1/search/hot-keywords", CurrentBehavior: "legacy hot news compatibility pages removed after formal hot keyword API migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateExternalContract},
	{LegacyPath: "/dist/*", OwnerModule: "UserAuthController", FormalTarget: "/login", CurrentBehavior: "legacy trial application pages removed after portal migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateExternalContract},
	{LegacyPath: "/img/code", OwnerModule: "ImageController", FormalTarget: "/login", CurrentBehavior: "legacy captcha endpoint removed after login migration", Strategy: legacyStrategyGone, RemovalGate: legacyRemovalGateExternalContract},
