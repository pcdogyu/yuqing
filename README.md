...
> 当前分支已经完成 Java 到 Go 的运行链路收口。活跃服务、启动脚本、调度任务和发布验收均在 `go/` 目录下维护；根 Maven 工程与 `src/main/java` 已退场。历史 Java 版介绍仅作为项目背景保留，当前部署请以 [go/README.md](go/README.md) 为准。
...
当前 Go 运行版技术栈见 [go/README.md](go/README.md)。以下为历史 Java 版本资料，仅作背景参考。
