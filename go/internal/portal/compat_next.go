...
func (s *Server) writeSimplePage(w http.ResponseWriter, _ string, title string, body string) error {
	...
	_, err := fmt.Fprintf(w, "<!doctype html><html><head><meta charset='utf-8'><title>%s</title><style>body{font-family:Segoe UI,system-ui;background:#f7f3eb;margin:0;color:#222}header,main{max-width:1100px;margin:0 auto;padding:24px}header{padding-bottom:0}header h1{margin:0 0 18px;font-size:30px;line-height:1.25}nav a{margin-right:16px;color:#214e34;text-decoration:none;font-weight:600}section{background:#fff;border-radius:16px;padding:20px;margin-top:20px;box-shadow:0 8px 24px rgba(0,0,0,.06)}a{color:#214e34;text-decoration:none}</style></head><body><header><h1>%s</h1>%s</header><main>%s</main></body></html>", html.EscapeString(title), html.EscapeString(title), portalNavHTML, body)
	return err
}
