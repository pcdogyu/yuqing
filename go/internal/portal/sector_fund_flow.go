...
.sector-scroll{overflow:auto}.sector-table{min-width:1380px;width:100%;table-layout:fixed}.sector-table th,.sector-table td{vertical-align:top}.sector-table th:nth-child(1),.sector-table td:nth-child(1){width:54px}.sector-table th:nth-child(2),.sector-table td:nth-child(2){width:140px}.sector-table th:nth-child(3),.sector-table td:nth-child(3){width:90px}.sector-table th:nth-child(12),.sector-table td:nth-child(12){width:150px}.sector-table th:nth-child(13),.sector-table td:nth-child(13){width:150px}.sector-num{text-align:right;white-space:nowrap}.sector-positive{color:#d93025;font-weight:700}.sector-negative{color:#087333;font-weight:700}.sector-empty{padding:18px;border:1px dashed #d0c8b8;border-radius:8px;background:#fff;color:#6a6257}
@media (max-width:760px){.sector-toolbar{grid-template-columns:1fr}.sector-head{display:block}}
	...
	renderSectorFundFlowTable(&b, ctx)
	_ = s.writeSimplePage(w, "sector-fund-flow", "版块资金", b.String())
}
...
func renderSectorFundFlowTable(b *strings.Builder, ctx model.AStockSectorFundFlowListResult) {
