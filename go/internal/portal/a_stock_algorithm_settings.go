...
func aStockAlgorithmParamDefs() []aStockAlgorithmParamDef {
	return []aStockAlgorithmParamDef{
		...
		{Group: "auction", GroupLabel: "竞价因子", Key: "auction.low_open_penalty_threshold_pct", Label: "低开硬过滤阈值", Unit: "%", Step: "0.01", Description: "低开低于该值时过滤"},
		{Group: "auction", GroupLabel: "竞价因子", Key: "auction.low_open_penalty", Label: "低开扣分", Unit: "分", Description: "低开风险扣分参数"},
		...
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_min_days", Label: "板块趋势最少天数", Unit: "天", Description: "板块资金趋势判断所需最少数据天数"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_score_min", Label: "板块趋势最低分", Unit: "分", Description: "板块趋势分下限"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_score_max", Label: "板块趋势最高分", Unit: "分", Description: "板块趋势分上限"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_turn_threshold", Label: "板块近2日拐点阈值", Unit: "元", Step: "1000000", Description: "板块近2日连续流入加分阈值"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_continuous_inflow_score", Label: "板块连续流入加分", Unit: "分", Description: "近5日板块连续流入加分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_partial_inflow_score", Label: "板块偏流入加分", Unit: "分", Description: "近5日板块偏流入加分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_weak_inflow_score", Label: "板块弱流入加分", Unit: "分", Description: "板块弱流入加分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_continuous_outflow_penalty", Label: "板块连续流出扣分", Unit: "分", Description: "近5日板块连续流出扣分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_partial_outflow_penalty", Label: "板块偏流出扣分", Unit: "分", Description: "近5日板块偏流出扣分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_weak_outflow_penalty", Label: "板块弱流出扣分", Unit: "分", Description: "板块弱流出扣分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_ten_day_acceleration_score", Label: "板块10日加速加分", Unit: "分", Description: "板块资金10日加速流入加分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_ten_day_outflow_penalty", Label: "板块10日流出扣分", Unit: "分", Description: "板块10日和5日均流出扣分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_recent_2d_inflow_score", Label: "板块近2日流入加分", Unit: "分", Description: "板块近2日连续流入加分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_recent_2d_outflow_penalty", Label: "板块近2日流出扣分", Unit: "分", Description: "板块近2日连续流出扣分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_rank_top10_score", Label: "板块排名前10加分", Unit: "分", Description: "板块资金排名前10加分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_rank_top30_score", Label: "板块排名前30加分", Unit: "分", Description: "板块资金排名前30加分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_latest_outflow_down_penalty", Label: "板块当日流出下跌扣分", Unit: "分", Description: "板块当日净流出且下跌扣分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.trend_choppy_penalty", Label: "板块资金震荡扣分", Unit: "分", Description: "板块资金方向震荡扣分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.top_stock_one_sector_score", Label: "共振1板块加分", Unit: "分", Description: "股票为1个正向板块代表股时加分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.top_stock_two_sector_score", Label: "共振2板块加分", Unit: "分", Description: "股票为2个正向板块代表股时加分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.top_stock_three_sector_score", Label: "共振3板块加分", Unit: "分", Description: "股票为3个及以上正向板块代表股时加分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.top_stock_large_inflow_threshold", Label: "共振大额流入阈值", Unit: "元", Step: "100000000", Description: "多个板块合计流入超过该值时额外加分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.top_stock_large_inflow_score", Label: "共振大额流入加分", Unit: "分", Description: "共振板块合计大额流入额外加分"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.top_stock_score_cap", Label: "共振总分封顶", Unit: "分", Description: "板块资金共振加分上限"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.top_stock_overheat_30_cap", Label: "30日过热共振封顶", Unit: "分", Description: "30日涨幅过热后共振加分封顶"},
		{Group: "sector", GroupLabel: "版块因子", Key: "sector.drawdown_penalty", Label: "板块回撤扣分", Unit: "分", Description: "同热点股票回撤过滤后对板块扣分"},

		{Group: "fund", GroupLabel: "资金因子", Key: "fund.bonus_threshold", Label: "5日流入一档阈值", Unit: "元", Step: "1000000", Description: "达到后给一档资金加分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.bonus_score", Label: "5日流入一档加分", Unit: "分", Description: "5日流入一档资金加分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.strong_bonus_threshold", Label: "5日流入二档阈值", Unit: "元", Step: "1000000", Description: "达到后给二档资金加分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.strong_bonus_score", Label: "5日流入二档加分", Unit: "分", Description: "5日流入二档资金加分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.very_strong_threshold", Label: "5日流入三档阈值", Unit: "元", Step: "1000000", Description: "达到后给三档资金加分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.very_strong_score", Label: "5日流入三档加分", Unit: "分", Description: "5日流入三档资金加分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.extreme_threshold", Label: "5日流入四档阈值", Unit: "元", Step: "1000000", Description: "达到后给四档资金加分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.extreme_score", Label: "5日流入四档加分", Unit: "分", Description: "5日流入四档资金加分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.negative_days_2_penalty", Label: "近5日流出2天扣分", Unit: "分", Description: "近5日净流出2天扣分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.negative_days_3_penalty", Label: "近5日流出3天扣分", Unit: "分", Description: "近5日净流出3天扣分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.negative_days_4_penalty", Label: "近5日流出4天扣分", Unit: "分", Description: "近5日净流出4天及以上扣分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.ten_day_acceleration_ratio", Label: "10日加速比例", Unit: "", Step: "0.01", Description: "5日流入占10日流入比例达到后加分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.ten_day_acceleration_score", Label: "10日加速加分", Unit: "分", Description: "资金10日加速流入加分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.ten_day_retreat_penalty", Label: "10日转退潮扣分", Unit: "分", Description: "10日净流入但5日转流出扣分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.ten_day_repair_cap", Label: "10日流出修复封顶", Unit: "分", Description: "10日流出但5日转流入时加分上限"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.recent_turn_threshold", Label: "近2日拐点阈值", Unit: "元", Step: "1000000", Description: "近2日连续流入加分阈值"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.recent_2d_inflow_score", Label: "近2日流入加分", Unit: "分", Description: "近2日连续流入加分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.recent_2d_outflow_penalty", Label: "近2日流出扣分", Unit: "分", Description: "近2日连续流出扣分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.latest_outflow_down_penalty", Label: "当日流出下跌扣分", Unit: "分", Description: "当日净流出且股价下跌扣分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.score_min", Label: "资金最低分", Unit: "分", Description: "最终资金分下限"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.score_max", Label: "资金最高分", Unit: "分", Description: "最终资金分上限"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.sector_weak_cap", Label: "板块走弱资金封顶", Unit: "分", Description: "板块当天走弱时个股资金加分封顶"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.sector_net_outflow_cap", Label: "板块流出资金封顶", Unit: "分", Description: "板块当日净流出时个股资金加分封顶"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.median_penalty", Label: "资金低于中位数扣分", Unit: "分", Description: "同热点中资金弱于中位数时扣分"},
		{Group: "fund", GroupLabel: "资金因子", Key: "fund.overheat_30_cap", Label: "30日过热资金封顶", Unit: "分", Description: "30日涨幅过热后资金加分封顶"},
