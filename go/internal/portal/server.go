...
.fundflow-chart{width:100%;height:721px;display:block}
...
.fundflow-rank-list{max-height:721px;overflow:auto}
...
<div class="fundflow-chart-wrap"><svg class="fundflow-chart" id="hotspot-fundflow-chart" viewBox="0 0 1104 721" role="img" aria-label="当日板块资金流向折线图"></svg></div>
