...
{{define "nav"}}<nav><a href="/">总览</a><a href="/projects">项目</a><a href="/monitor-rules">规则</a><a href="/articles">文章</a><a href="/reports">报告</a><a href="/crawl-templates">模板</a><a href="/crypto">Crypto</a><a href="/system">系统</a><a href="/logout">退出</a></nav>{{end}}
`
